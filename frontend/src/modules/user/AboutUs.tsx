        ...
        <div className="pb-24 md:pb-8 bg-white min-h-screen">
            ...
            <div className="px-4 md:px-6 lg:px-8 py-6 max-w-3xl mx-auto">
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-neutral-900 mb-2">Olovely Total Suvidha</h2>
                ...
                <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl p-6 border border-teal-200">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center gap-3 text-sm">
                            ...
                            <span className="text-neutral-700">support@olovely.com</span>
                        </div>
                        <div className="flex items-center gap-3 text-sm">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-teal-600 flex-shrink-0">
                ...
                <div className="mt-8 text-center">
                    ...
                    <p className="text-xs text-neutral-500 mt-1">© 2025 Olovely Total Suvidha. All rights reserved.</p>
                </div>
            </div>
        </div>
    );
